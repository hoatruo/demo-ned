 ...
 *
 */
package com.tailf.packages.ned.jvx;

import com.tailf.packages.ned.jvx.namespaces.*;
...
public class JVXNedGeneric extends NedGenericBase  {

    private static final String IDENTITY = "http://tail-f.com/ned/GRX";
    private static final String MODULE   = "GRX";
    private static final String TYPE     = "generic";
    private static final String PREFIX   = "jvx:";
    ...
    private static Logger logger = Logger.getLogger(JVXNedGeneric.class);
     ...
     * NED Constructors
     */
    public JVXNedGeneric(){
        logger.debug("JVXNedGeneric constructor");
    }


    @SuppressWarnings({ "deprecation", "nls" })
	public JVXNedGeneric(String deviceId,
                                 InetAddress ip,
                                 int port,
                                 String luser,
                                 boolean trace,
        ...
        // TODO: Uncomment below if you need stats
                 ...
                 this.stats_capas[0] = new NedCapability("",
                                                         "http://com/tailf/packages/ned/GRX/stats",
                                                         "GRX-stats",
                                                         "",
                                                         DATE,
                                                         "");
	...
	logger.debug("TEST-LOGGING json: " + json);
	...
	JSONObject conf = new JSONObject(json);
        conf.put("key", conf.getString("key").toUpperCase());
        json = conf.toString();
...
//    }
    ...
    public NedGenericBase newConnection(String deviceId,
        ...
        JVXNedGeneric ned = new JVXNedGeneric(deviceId,
                                  ip,
                                  port,
                                  luser,
                                  trace,
	...
	private String modifyToNcsFormat(String data, String module, String rootTag) throws Exception {
		data = data.replaceAll("<" + module + ">", "<" + module + " xmlns:" + tailfJVXNedGeneric.prefix
				+ "=\"" + tailfJVXNedGeneric.uri + "\">");
		data = data.replaceAll("<", "<" + tailfJVXNedGeneric.prefix + ":");
		data = data.replaceAll("<" + tailfJVXNedGeneric.prefix + ":/",
				"</" + tailfJVXNedGeneric.prefix + ":");
		data = data.replaceAll("<" + tailfJVXNedGeneric.prefix + ":" + rootTag + ">",
				"<" + rootTag + ">");
		...
		data = data.replaceAll("<" + tailfJVXNedGeneric.prefix + ":" + rootTag + "/>",
				"<" + rootTag + "/>");
		data = data.replaceAll("<" + tailfJVXNedGeneric.prefix + ":\\?xml", "<?xml");
		return data;
	}
}
